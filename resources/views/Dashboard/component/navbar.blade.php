...
<!-- Mirrored from dompet.dexignlab.com/xhtml/ by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Dec 2022 06:42:01 GMT -->
                ...
                <nav class="navbar navbar-expand">
                    <div class="collapse navbar-collapse justify-content-between">
                        ...
                        <ul class="navbar-nav header-right">
                            ...
                            <li class="nav-item">
                                <a href="{{url('logout')}}" class="btn btn-danger d-sm-inline-block d-none">Logout</a>
                            </li>
                        </ul>
                    </div>
                </nav>
                ...
                <ul class="metismenu" id="menu">
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            ...
                            <li><a href="{{url('AF')}}">Addmission Form</a></li>
                            <li><a href="{{url('All-Student')}}">All Student</a></li>
                            <li><a href="{{url('Go-To-Class')}}">Classes</a></li>
                        </ul>
