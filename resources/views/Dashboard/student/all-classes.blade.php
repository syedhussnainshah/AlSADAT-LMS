        ...
        <div class="col-xl-3 col-xxl-3 col-sm-6">
            <div class="card bg-warning invoice-card">
                <div class="card-body d-flex">
                    ...
                    <div>
                        <!-- <span class="text-white fs-18">Campus::1</span> -->
                    </div>
                    <h2 class="text-white invoice-num">{{$class->class_name}}</h2>
                </div>
                <div class="btn-group">
                    <a href="{{url('Campus-Attendance',$class->class_id)}}" class="btn btn-danger text-white">Attendace</a>
                    <a href="" class="btn btn-primary text-white">Students</a>
                </div>
            </div>
        </div>
        @endforeach
